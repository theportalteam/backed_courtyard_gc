...
const variantStyles = {
  primary:
    "bg-primary hover:bg-primary-hover text-on-primary shadow-lg shadow-primary/25 rounded-button",
  secondary:
  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "inline-flex items-center justify-center uppercase tracking-wider font-headline font-bold transition-all duration-200",
